...
const TEAM_NAMES_HE = {
    ...
    'Bolivia': 'בוליביה',
    // CONCACAF
    'Haiti': 'האיטי', 'Panama': 'פנמה', 'Curacao': 'קוראסאו',
    'Curaçao': 'קוראסאו', 'Honduras': 'הונדורס', 'Costa Rica': 'קוסטה ריקה',
    'El Salvador': 'אל סלבדור', 'Jamaica': "ג'מייקה",
    'Trinidad and Tobago': 'טרינידד וטובגו', 'Guatemala': 'גואטמלה',
    'Cuba': 'קובה', 'Dominican Republic': 'הרפובליקה הדומיניקנית',
    // אוקיאניה
    'New Zealand': 'ניו זילנד', 'Fiji': "פיג'י",
    // קוריאה
