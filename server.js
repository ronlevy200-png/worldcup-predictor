...
const TEAM_NAMES_HE = {
    ...
    'Bosnia and Herzegovina': 'בוסניה', 'Slovakia': 'סלובקיה',
    'Hungary': 'הונגריה', 'Romania': 'רומניה', 'Slovenia': 'סלובניה',
    'Albania': 'אלבניה', 'Greece': 'יוון', 'Finland': 'פינלנד',
    'Iceland': 'איסלנד', 'Wales': 'ויילס', 'Northern Ireland': 'צפון אירלנד',
    'Republic of Ireland': 'אירלנד', 'Kosovo': 'קוסובו',
    // דרום אמריקה
    'Brazil': 'ברזיל', 'Argentina': 'ארגנטינה', 'Uruguay': 'אורוגוואי',
    'Colombia': 'קולומביה', 'Ecuador': 'אקוודור', 'Paraguay': 'פרגוואי',
    'Chile': 'צילה', 'Peru': 'פרו', 'Venezuela': 'ונצואלה',
    'Bolivia': 'בוליביה',
    // CONCACAF
    'Haiti': 'האיטי', 'Panama': 'פנמה', 'Curaçao': 'קוראסאו',
    'Honduras': 'הונדורס', 'Costa Rica': 'קוסטה ריקה',
    'El Salvador': 'אל סלבדור', 'Jamaica': 'גמייקה',
